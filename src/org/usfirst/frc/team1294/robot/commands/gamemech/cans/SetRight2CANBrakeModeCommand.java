 ...
 *
 */
public class SetRight2CANBrakeModeCommand extends Command {

    public SetRight2CANBrakeModeCommand(BrakeMode mode) {
        // Use requires() here to declare subsystem dependencies
        // eg. requires(chassis);
    	requires(Robot.RIGHT2CAN_SUBSYSTEM);
    	Robot.RIGHT2CAN_SUBSYSTEM.setBrakeMode(mode);
    }
